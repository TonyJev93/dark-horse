...
export function createActionCardDeck(): ActionCard[] {
  ...
  const singleMovementCards: SingleMovementCard[] = [
    { type: "single_movement", horseNumber: 1, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 1, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 2, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 2, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 3, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 3, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 4, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 4, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 5, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 5, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 6, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 6, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 7, spaces: 1, direction: "choice" },
    { type: "single_movement", horseNumber: 7, spaces: 1, direction: "choice" },
